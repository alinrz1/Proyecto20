...
namespace Proyecto20.Controllers
{
    public class TurnoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_Turno,Nombre,Descripcion,Status")] Turno turno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Turno,Nombre,Descripcion,Status")] Turno turno)
        {
            if (ModelState.IsValid)
            {
